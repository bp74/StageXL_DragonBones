...
part 'src/data/bone_animation.dart';
part 'src/data/bone_animation_frame.dart';
part 'src/data/display.dart';
part 'src/data/mesh.dart';
part 'src/data/mesh_animation.dart';
part 'src/data/mesh_animation_frame.dart';
part 'src/data/skin.dart';
part 'src/data/skin_slot.dart';
part 'src/data/slot.dart';
part 'src/data/slot_animation.dart';
part 'src/data/slot_animation_frame.dart';
...
part 'src/skeleton/skeleton_display.dart';
part 'src/skeleton/skeleton_display_armature.dart';
part 'src/skeleton/skeleton_display_image.dart';
part 'src/skeleton/skeleton_display_mesh.dart';
part 'src/skeleton/skeleton_mesh_animation.dart';
